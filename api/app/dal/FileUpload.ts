...
export const create = async (payload: FileModelInput): Promise<FileModelOutput> => {
    const _files = await FileUpload.create(payload);
    return _files;
}

export const update = async (id: number, payload: Partial<FileModelInput>): Promise<FileModelOutput> => {
